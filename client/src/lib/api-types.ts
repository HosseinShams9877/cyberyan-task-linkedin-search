 ...
 *
 * Copy of server/src/types/api.ts. The two files are intentionally duplicated
 * instead of shared through a workspace package, because Vercel installs client/
 * and server/ as independent entrypoints — keep them in sync when the API changes.
 */
